...
// ─── TL-SEL dimension config ──────────────────────────────────────────────────
const INITIAL_DIMENSIONS: Dimension[] = [
  {
    letter: "A", title: "STRATEGIC LEADERSHIP, ADVOCACY AND CAPACITY BUILDING",
    objective: "To provide strategic direction and strengthen institutional and ecosystem capacity in sustainable entrepreneurship and livelihoods.",
    kras: [
      { name: "Technical Leadership and Capacity Building", description: "Strengthens internal capabilities and provides expert guidance in sustainable entrepreneurship and livelihoods.", rating: "", comment: "" },
      { name: "Ecosystem Engagement and Stakeholder Mapping", description: "Identifies and engages key actors and support organizations within the ecosystem.", rating: "", comment: "" },
      { name: "Advocacy and Thought Leadership", description: "Promotes awareness and emerging trends in sustainable entrepreneurship and livelihoods.", rating: "", comment: "" },
      { name: "Communication and Public Engagement", description: "Supports advocacy initiatives and strategic communication interventions.", rating: "", comment: "" },
      { name: "Quality Assurance of Programs", description: "Ensures quality implementation of incubation, acceleration and productivity enhancement initiatives.", rating: "", comment: "" },
      { name: "Strategic Advisory Support", description: "Provides strategic guidance on humanitarian and development interventions that enhance livelihoods.", rating: "", comment: "" }
    ],
  },
  {
    letter: "B", title: "PROGRAM DEVELOPMENT, PLANNING AND MANAGEMENT",
    objective: "To design, implement and manage inclusive and sustainable entrepreneurship and livelihood programs that deliver transformational impact.",
    kras: [
      { name: "Program Design and Development", description: "Leads formulation and development of sustainable entrepreneurship and livelihood interventions.", rating: "", comment: "" },
      { name: "Strategic Alignment and Framework Development", description: "Ensures programs align with the strategic plan and ecosystem priorities.", rating: "", comment: "" },
      { name: "Inclusion and Livelihood Transformation", description: "Promotes interventions that improve livelihoods among marginalized and vulnerable populations.", rating: "", comment: "" },
      { name: "Gender Equality and Social Inclusion", description: "Ensures programs contribute to gender equality and youth empowerment.", rating: "", comment: "" },
      { name: "Resource and Financial Planning", description: "Oversees resource allocation and identification of technical expertise required for program delivery.", rating: "", comment: "" },
      { name: "Innovation and Adaptive Programming", description: "Develops innovative implementation approaches that respond to changing operating environments.", rating: "", comment: "" }
    ],
  },
  {
    letter: "C", title: "PROGRAM PERFORMANCE MANAGEMENT, MONITORING, EVALUATION, LEARNING AND REPORTING",
    objective: "To strengthen accountability, performance measurement and evidence-based decision-making across all program areas.",
    kras: [
      { name: "Workplan Development and Review", description: "Develops and reviews program workplans to ensure effective implementation.", rating: "", comment: "" },
      { name: "Monitoring and Evaluation Systems", description: "Ensures robust monitoring, evaluation and impact assessment processes.", rating: "", comment: "" },
      { name: "Performance Reporting and Accountability", description: "Produces quality reports that demonstrate results, learning and accountability.", rating: "", comment: "" },
      { name: "Financial Oversight and Budget Monitoring", description: "Oversees expenditure and ensures efficient use of resources.", rating: "", comment: "" },
      { name: "Organizational Learning and Knowledge Sharing", description: "Promotes learning and knowledge exchange across programs and teams.", rating: "", comment: "" },
      { name: "Results Measurement and Quality Assurance", description: "Ensures achievement of targets, indicators and program outcomes.", rating: "", comment: "" }
    ],
  },
  {
    letter: "D", title: "PARTNERSHIPS, RESOURCE MOBILIZATION AND EXTERNAL RELATIONS",
    objective: "To strengthen strategic partnerships and mobilize resources that support sustainable program growth and impact.",
    kras: [
      { name: "Partnership Development", description: "Builds and maintains relationships with donors, technical experts and strategic partners.", rating: "", comment: "" },
      { name: "Resource Mobilization and Fundraising", description: "Supports acquisition of financial and technical resources for program implementation.", rating: "", comment: "" },
      { name: "Collaboration with Cross-Cutting Units", description: "Ensures integrated programming and effective coordination with support functions.", rating: "", comment: "" },
      { name: "Inter-Organizational Synergies", description: "Promotes collaboration and complementarities across subsidiaries and partner institutions.", rating: "", comment: "" },
      { name: "Stakeholder Engagement and Representation", description: "Represents the organization in national and international engagements and networks.", rating: "", comment: "" }
    ],
  },
  {
    letter: "E", title: "TEAM LEADERSHIP, PEOPLE MANAGEMENT AND ORGANIZATIONAL PERFORMANCE",
    objective: "To foster a high-performing team culture that delivers quality results and promotes continuous improvement.",
    kras: [
      { name: "Team Leadership and Supervision", description: "Provides leadership and direction to program teams and analysts.", rating: "", comment: "" },
      { name: "Performance Management and Accountability", description: "Ensures achievement of targets and organizational objectives.", rating: "", comment: "" },
      { name: "Staff Development and Coaching", description: "Supports learning, mentorship and professional growth of team members.", rating: "", comment: "" },
      { name: "Cross-Functional Collaboration", description: "Promotes teamwork and collaboration across departments.", rating: "", comment: "" },
      { name: "Organizational Effectiveness", description: "Enhances efficiency, productivity and continuous improvement.", rating: "", comment: "" }
    ],
  },
  {
    letter: "F", title: "POLICY MANAGEMENT, SAFEGUARDING AND COMPLIANCE",
    objective: "To ensure programs and partnerships are implemented in accordance with organizational policies, safeguarding principles and regulatory standards.",
    kras: [
      { name: "Policy Development and Implementation", description: "Supports review and implementation of policies and operational guidelines.", rating: "", comment: "" },
      { name: "Program and Partnership Compliance", description: "Ensures adherence to approved procedures and standards.", rating: "", comment: "" },
      { name: "Safeguarding, GESI and Inclusion", description: "Promotes safeguarding, gender equality and social inclusion principles.", rating: "", comment: "" },
      { name: "Risk Management and Accountability", description: "Strengthens governance, transparency and responsible resource utilization.", rating: "", comment: "" },
      { name: "Ethics and Professional Conduct", description: "Demonstrates integrity, professionalism and commitment to organizational values.", rating: "", comment: "" }
    ],
  }
];
...
// ─── Main Form ────────────────────────────────────────────────────────────────
export default function TLSELTeamLeaderSustainableEntrepreneurshipForm() {
  const [employeeId, setEmployeeId] = useState("");
  const [employeeName, setEmployeeName] = useState("");
  const [position, setPosition] = useState("Team Leader - Sustainable Entrepreneurship and Livelihoods (TL-SEL)");
  ...
  const { clearDraft } = useFormDraft("tl-sel-team-leader-sustainable-entrepreneurship", {
    ...
    <div style={{ fontFamily: "Verdana, Geneva, sans-serif", color: "#222", background: "#f0f4f5", padding: "40px 24px 60px", minHeight: "100vh" }}>
      ...
      <div ref={formTopRef} className="af" style={{ maxWidth: 1050, margin: "0 auto", background: "#fff", border: "2px solid #4C808A", borderRadius: 8, padding: "40px 36px 48px", lineHeight: 1.45 }}>
        ...
        <div className="mh">
          ...
          <p className="subtitle">Team Leader - Sustainable Entrepreneurship and Livelihoods</p>
        </div>
        ...
        <p className="ov">This 360-degree performance appraisal evaluates the Team Leader – Sustainable Entrepreneurship and Livelihoods across six core dimensions derived from the role's scope of responsibilities. The appraisal places strong emphasis on Strategic Leadership and Capacity Building, Program Development and Management, Monitoring, Evaluation and Learning, Partnerships and Resource Mobilization, Team Leadership and Organizational Performance and Policy Management and Compliance, recognizing their critical role in driving sustainable entrepreneurship, livelihoods transformation and organizational impact in support of Emerge Livelihoods' Strategic Plan 2024–2029.</p>
