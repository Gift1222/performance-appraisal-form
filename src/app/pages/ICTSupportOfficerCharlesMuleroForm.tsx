...
// ─── ICT Support Officer (Charles Mulero) dimension config ───────────────────
const INITIAL_DIMENSIONS: Dimension[] = [
  {
    letter: "A", title: "ICT PLANNING, MANAGEMENT AND OPERATIONS",
    objective: "To support effective planning, coordination and implementation of ICT services and technical operations that strengthen organizational performance.",
    kras: [
      { name: "ICT Support Planning", description: "Develops and implements periodic ICT support plans aligned with organizational priorities.", rating: "", comment: "" },
      { name: "ICT Resource Management", description: "Supports management and availability of desktops, laptops, printers and software resources.", rating: "", comment: "" },
      { name: "Technical Project Coordination", description: "Coordinates ICT-related projects and initiatives to ensure successful operations.", rating: "", comment: "" },
      { name: "Operational Efficiency", description: "Ensures ICT systems and services contribute to organizational productivity and effectiveness.", rating: "", comment: "" },
      { name: "Budget and Resource Support", description: "Supports efficient utilization of ICT resources and operational expenditures.", rating: "", comment: "" },
    ],
  },
  {
    letter: "B", title: "TECHNICAL SUPPORT AND SERVICE DELIVERY",
    objective: "To provide responsive, reliable and client-centered technical support that ensures optimal system performance and user satisfaction.",
    kras: [
      { name: "User Support Services", description: "Provides frontline support and resolves ICT-related issues efficiently.", rating: "", comment: "" },
      { name: "Stakeholder Engagement and Customer Service", description: "Collaborates with internal and external stakeholders to provide quality support services.", rating: "", comment: "" },
      { name: "Systems and Network Performance", description: "Maintains ICT devices, systems and networks at optimum functionality.", rating: "", comment: "" },
      { name: "Incident and Service Restoration", description: "Supports timely restoration of services and minimizes downtime.", rating: "", comment: "" },
      { name: "Team Collaboration and Support", description: "Works collaboratively with technical operations teams and provides backup support when required.", rating: "", comment: "" },
    ],
  },
  {
    letter: "C", title: "SYSTEMS ADMINISTRATION, PERFORMANCE MANAGEMENT AND ACCOUNTABILITY",
    objective: "To strengthen ICT service quality through effective systems administration, performance monitoring and accountability mechanisms.",
    kras: [
      { name: "ICT Systems Administration", description: "Manages setup, maintenance and operation of ICT devices and systems.", rating: "", comment: "" },
      { name: "KPI Monitoring and Reporting", description: "Tracks performance indicators and reports on service delivery outcomes.", rating: "", comment: "" },
      { name: "Budget Monitoring", description: "Ensures expenditure remains within approved limits and resources are utilized effectively.", rating: "", comment: "" },
      { name: "Documentation and Knowledge Resources", description: "Develops and maintains support documentation and reference materials.", rating: "", comment: "" },
      { name: "Standardization and Quality Assurance", description: "Promotes standard operating procedures, tools and best practices to enhance efficiency and consistency.", rating: "", comment: "" },
    ],
  },
  {
    letter: "D", title: "DIGITAL CONTENT MANAGEMENT AND KNOWLEDGE SHARING",
    objective: "To strengthen digital communication, knowledge management and organizational visibility through effective content development and system management.",
    kras: [
      { name: "Multimedia Content Development", description: "Produces and implements digital and multimedia content to support program objectives.", rating: "", comment: "" },
      { name: "Marketing and Communication Materials", description: "Develops and disseminates print and digital materials for organizational initiatives.", rating: "", comment: "" },
      { name: "Systems Maintenance and Reporting", description: "Maintains digital platforms and provides reports on system performance.", rating: "", comment: "" },
      { name: "Online Presence Management", description: "Promotes consistent and coordinated management of digital content and platforms.", rating: "", comment: "" },
      { name: "Knowledge Management Support", description: "Facilitates dissemination and sharing of organizational knowledge products and information.", rating: "", comment: "" },
    ],
  },
  {
    letter: "E", title: "CONTINUOUS IMPROVEMENT, LEARNING AND INNOVATION",
    objective: "To promote innovation, learning and continuous improvement in ICT systems and service delivery.",
    kras: [
      { name: "Digital Innovation", description: "Promotes the use of emerging technologies and digital tools to improve operations.", rating: "", comment: "" },
      { name: "Learning and Continuous Improvement", description: "Encourages continuous learning and adoption of best practices in ICT support.", rating: "", comment: "" },
      { name: "Data and Analytics Utilization", description: "Supports the use of monitoring, analytics and quality assurance systems for decision-making.", rating: "", comment: "" },
      { name: "Organizational Knowledge Sharing", description: "Facilitates sharing of lessons learned and technical knowledge across teams.", rating: "", comment: "" },
      { name: "Service Improvement Initiatives", description: "Identifies opportunities for enhancing ICT processes and user experience.", rating: "", comment: "" },
    ],
  },
  {
    letter: "F", title: "POLICY MANAGEMENT, SAFEGUARDING AND COMPLIANCE",
    objective: "To ensure ICT operations comply with organizational policies, safeguarding standards and professional requirements.",
    kras: [
      { name: "Policy Development and Implementation", description: "Supports development, review and implementation of ICT policies and procedures.", rating: "", comment: "" },
      { name: "Regulatory and Organizational Compliance", description: "Ensures adherence to approved organizational standards and requirements.", rating: "", comment: "" },
      { name: "Safeguarding, GESI and Protection", description: "Promotes safeguarding, gender equality, social inclusion and equitable access to digital services.", rating: "", comment: "" },
      { name: "Risk Management and Information Protection", description: "Supports risk mitigation and secure management of ICT resources and systems.", rating: "", comment: "" },
      { name: "Ethics and Professional Conduct", description: "Upholds integrity, accountability, confidentiality and professionalism in ICT operations.", rating: "", comment: "" },
    ],
  },
];
...
export default function ICTSupportOfficerCharlesMuleroForm() {
  ...
  const { clearDraft } = useFormDraft("ict-support-officer-charles-mulero", {
  ...
  return (
    <div style={{ fontFamily: "Verdana, Geneva, sans-serif", color: "#222", background: "#f0f4f5", padding: "40px 24px 60px", minHeight: "100vh" }}>
      ...
      <div ref={formTopRef} className="af" style={{ maxWidth: 1050, margin: "0 auto", background: "#fff", border: "2px solid #4C808A", borderRadius: 8, padding: "40px 36px 48px", lineHeight: 1.45 }}>
        ...
        <p className="ov">This 360-degree performance appraisal evaluates the ICT Support Officer across six core dimensions derived from the role&rsquo;s scope of responsibilities. The appraisal places strong emphasis on <strong>ICT Planning and Operations, Technical Support and Service Delivery, Systems Administration and Performance Management, Digital Content and Knowledge Management, Continuous Improvement and Innovation and Policy Management and Compliance</strong>, recognizing their critical role in enabling effective digital transformation, user support, operational efficiency and technology adoption in support of Emerge Livelihoods&rsquo; Strategic Plan 2024&ndash;2029.</p>
