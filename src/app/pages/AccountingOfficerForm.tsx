...
// ─── Accounting Officer dimension config ─────────────────────────────────────
const INITIAL_DIMENSIONS: Dimension[] = [
  {
    letter: "A", title: "ACCOUNTING AND FINANCIAL REPORTING",
    objective: "To maintain accurate financial records and ensure timely preparation of financial reports that support organizational accountability and decision-making.",
    kras: [
      { name: "Financial Record Management", description: "Ensures proper and reliable accounting books, ledgers and records are maintained in accordance with organizational policies.", rating: "", comment: "" },
      { name: "Transaction Processing", description: "Ensures prompt and accurate recording of all financial and non-financial transactions in QuickBooks and related systems.", rating: "", comment: "" },
      { name: "Financial Reporting", description: "Prepares accurate monthly, quarterly and periodic financial reports for review and decision-making.", rating: "", comment: "" },
      { name: "Fixed Asset Management", description: "Maintains an accurate fixed asset register and ensures proper depreciation calculations and reporting.", rating: "", comment: "" },
      { name: "Documentation and Filing", description: "Ensures payment vouchers, receipts, journal vouchers and supporting documents are accurately prepared, filed and accessible.", rating: "", comment: "" },
    ],
  },
  {
    letter: "B", title: "STATUTORY AND REGULATORY COMPLIANCE",
    objective: "To ensure compliance with all statutory, regulatory and audit requirements while minimizing organizational risk.",
    kras: [
      { name: "Tax Compliance", description: "Ensures timely filing and payment of taxes and statutory obligations to relevant authorities.", rating: "", comment: "" },
      { name: "Regulatory Compliance", description: "Maintains compliance with existing and emerging financial regulations and legal requirements.", rating: "", comment: "" },
      { name: "Audit Coordination", description: "Supports and coordinates internal and external audit processes to ensure timely completion.", rating: "", comment: "" },
      { name: "Risk Mitigation", description: "Identifies compliance risks and supports corrective actions to avoid penalties and sanctions.", rating: "", comment: "" },
    ],
  },
  {
    letter: "C", title: "PAYROLL MANAGEMENT",
    objective: "To ensure timely, accurate and compliant payroll processing and employee compensation administration.",
    kras: [
      { name: "Payroll Processing", description: "Ensures accurate and timely preparation of monthly payroll for review and approval.", rating: "", comment: "" },
      { name: "Statutory Payroll Deductions", description: "Ensures taxes, pensions and other payroll deductions are calculated and remitted accurately and on time.", rating: "", comment: "" },
      { name: "Payroll Reconciliation", description: "Maintains accurate reconciliation between payroll and accounting records.", rating: "", comment: "" },
      { name: "Employee Payroll Services", description: "Ensures payroll records, staff loan registers and payslips are accurate and distributed promptly.", rating: "", comment: "" },
    ],
  },
  {
    letter: "D", title: "BANKING AND TREASURY MANAGEMENT",
    objective: "To manage cash resources effectively and ensure accurate banking transactions and reconciliations.",
    kras: [
      { name: "Cash and Banking Operations", description: "Ensures prompt banking of remittances and proper recording of banking transactions.", rating: "", comment: "" },
      { name: "Bank Reconciliation", description: "Prepares accurate and timely bank reconciliation statements for review.", rating: "", comment: "" },
      { name: "Cash Flow Management", description: "Monitors daily cash balances to maintain adequate liquidity and avoid overdrafts.", rating: "", comment: "" },
      { name: "Treasury Controls", description: "Maintains effective controls over cash and banking activities in line with organizational procedures.", rating: "", comment: "" },
    ],
  },
  {
    letter: "E", title: "BUSINESS DEVELOPMENT, TEAMWORK AND SUPPORT",
    objective: "To contribute to organizational growth, grant management and a collaborative working environment.",
    kras: [
      { name: "Team Collaboration", description: "Promotes teamwork, accountability, communication and positive working relationships within the finance team.", rating: "", comment: "" },
      { name: "Capacity Building", description: "Supports volunteers, interns and staff through coaching, training and knowledge sharing.", rating: "", comment: "" },
      { name: "Grant Financial Support", description: "Provides financial information and analysis to support grant implementation and management.", rating: "", comment: "" },
      { name: "Proposal Development Support", description: "Contributes financial inputs and budgeting support during grant proposal development.", rating: "", comment: "" },
      { name: "Donor Financial Reporting", description: "Supports the preparation and submission of donor financial reports in accordance with donor requirements.", rating: "", comment: "" },
    ],
  },
  {
    letter: "F", title: "POLICY MANAGEMENT AND COMPLIANCE",
    objective: "To support the development, implementation and adherence to organizational finance policies and procedures.",
    kras: [
      { name: "Policy Implementation", description: "Implements finance and accounting policies, procedures and guidelines effectively.", rating: "", comment: "" },
      { name: "Policy Review and Improvement", description: "Participates in the review and updating of finance policies and procedures.", rating: "", comment: "" },
      { name: "Compliance Monitoring", description: "Ensures staff and stakeholders adhere to approved financial policies and controls.", rating: "", comment: "" },
      { name: "Governance and Safeguarding", description: "Upholds organizational values, safeguarding standards, transparency, accountability and legislative requirements.", rating: "", comment: "" },
    ],
  },
  {
    letter: "G", title: "HUMAN RESOURCE AND PROFESSIONAL DEVELOPMENT",
    objective: "To contribute to a high-performing finance team and continuously improve professional competence.",
    kras: [
      { name: "Team Support", description: "Supports the Finance Director and Accountant in fostering a productive and accountable finance team.", rating: "", comment: "" },
      { name: "Performance Contribution", description: "Demonstrates initiative, reliability and professionalism in achieving departmental goals.", rating: "", comment: "" },
      { name: "Learning and Development", description: "Participates in professional development activities to enhance financial management competencies.", rating: "", comment: "" },
      { name: "Organizational Values", description: "Demonstrates commitment to Emerge Livelihoods\u2019 values, ethics, integrity, inclusion and accountability.", rating: "", comment: "" },
    ],
  },
];
...
// ─── Main Form ────────────────────────────────────────────────────────────────
export default function AccountingOfficerForm() {
  const [employeeId, setEmployeeId] = useState("");
  const [employeeName, setEmployeeName] = useState("");
  const [position, setPosition] = useState("Accounting Officer");
  ...
  const { clearDraft } = useFormDraft("accounting-officer", {
  ...
  function resetForm() {
    setEmployeeId(""); setEmployeeName(""); setPosition("Accounting Officer"); setReviewPeriod(""); setAppraisalDate(""); setReviewers("");
    ...
    <div style={{ fontFamily: "Verdana, Geneva, sans-serif", color: "#222", background: "#f0f4f5", padding: "40px 24px 60px", minHeight: "100vh" }}>
      ...
      <div ref={formTopRef} className="af" style={{ maxWidth: 1050, margin: "0 auto", background: "#fff", border: "2px solid #4C808A", borderRadius: 8, padding: "40px 36px 48px", lineHeight: 1.45 }}>
        ...
        <div className="mh">
          ...
          <p className="subtitle">Accounting Officer</p>
        </div>
        ...
        <p className="ov">This 360-degree performance appraisal evaluates the Accounting Officer across seven core dimensions derived from the role&rsquo;s scope of responsibilities. The appraisal emphasizes <strong>Accounting and Financial Reporting, Statutory Compliance, Payroll Management and Banking and Treasury Management</strong>, recognizing their critical role in maintaining financial integrity, transparency, accountability and regulatory compliance in support of Emerge Livelihoods&rsquo; Strategic Plan 2024&ndash;2029.</p>
