...
// ─── IPA-A dimension config ──────────────────────────────────────────────────
const INITIAL_DIMENSIONS: Dimension[] = [
  {
    letter: "A", title: "PROGRAM PLANNING, MANAGEMENT AND IMPLEMENTATION",
    objective: "To ensure effective program planning, management and implementation of acceleration projects.",
    kras: [
      { name: "Strategy and Thesis Development", description: "Support in the development of strategy and supporting thesis for all acceleration programs under Emerge Livelihoods", rating: "", comment: "" },
      { name: "Workplan Coordination", description: "Coordinate development of a workplan towards achieving the programs milestones and objectives", rating: "", comment: "" },
      { name: "Alignment of Priorities", description: "Review and ensure alignment of program priorities, strategies and plans to support partner priorities", rating: "", comment: "" },
      { name: "Localization Strategy Alignment", description: "Ensure Emerge Livelihoods acceleration program activities are grounded and strongly aligned with the localization strategy at national level", rating: "", comment: "" },
      { name: "Implementation Quality", description: "Ensure quality and effective implementation of all acceleration projects under Emerge Livelihoods", rating: "", comment: "" },
      { name: "Learning and Documentation", description: "Ensure all learning and knowledge is documented in the most effective approach demonstrating value for money and return on investment", rating: "", comment: "" }
    ],
  },
  {
    letter: "B", title: "RECRUITMENT, SELECTION AND PORTFOLIO MANAGEMENT",
    objective: "To effectively recruit, select and manage the portfolio of high growth climate focused MSMEs.",
    kras: [
      { name: "Investment Analysis", description: "Lead in developing an investment analysis targeting climate focused high growth MSMEs across sustainability sectors in Malawi and beyond focused on understanding the people, communities and emerging opportunities across the markets", rating: "", comment: "" },
      { name: "Sourcing and Screening", description: "Lead on the identification, sourcing and screening of climate focused high growth potential MSMEs that align with the Emerge Livelihoods impact framework", rating: "", comment: "" },
      { name: "Opportunity Dissemination", description: "Collaborate with the Emerge Livelihoods Communications and marketing teams in disseminating available opportunities for climate focused high growth potential MSMEs", rating: "", comment: "" },
      { name: "Pipeline Development", description: "Develop and curate a pipeline of high impact companies from sourcing database", rating: "", comment: "" },
      { name: "Partner Briefs", description: "Develop partner brief books for acceleration program cohort companies", rating: "", comment: "" },
      { name: "Portfolio Engagement", description: "Coordinating portfolio engagement through one on one and group engagement sessions", rating: "", comment: "" }
    ],
  },
  {
    letter: "C", title: "ACCELERATION AND INVESTMENT READINESS PROGRAM ACTIVITIES",
    objective: "To coordinate and implement acceleration and investment readiness activities.",
    kras: [
      { name: "Activity Coordination and Documentation", description: "Coordinate implementation of all acceleration program activities across communities to ensure alignment and contribution to Emerge Livelihoods strategy, tracking the information flow and systematic documentation of both qualitative and quantitative achievements in the communities and key lessons learnt for future reference", rating: "", comment: "" },
      { name: "Investment Potential Development", description: "Lead in developing a program cohort companies investment potential providing strategic advice on investment readiness", rating: "", comment: "" },
      { name: "Program Planning Alignment", description: "Coordinate planning and implementation of Emerge Livelihoods acceleration programming ensuring alignment with investors priorities", rating: "", comment: "" },
      { name: "Investor Recruitment and Matching", description: "Facilitate recruitment of a wide range of investors for investor-entrepreneur matching to support the enterprises to scale efficiently", rating: "", comment: "" },
      { name: "Investment Offering Preparation", description: "To support emerging enterprises, prepare their investment offering for available matching grants and investment facilities under Emerge Livelihoods (Emerge Fund)", rating: "", comment: "" },
      { name: "Performance Reporting", description: "Ensure quality and timely submission of program and project activity implementation and performance reports according to the desired standards and guidelines in place", rating: "", comment: "" },
      { name: "Program Compliance", description: "Ensure adequate compliance of approved acceleration program and project plans", rating: "", comment: "" },
      { name: "Evidence-Based Learning", description: "Promote evidence-based learning and ensure the agenda of advancing alternatives is adopted", rating: "", comment: "" },
      { name: "Knowledge Sharing Representation", description: "Represent Emerge Livelihoods and the Programs Department in various programs related knowledge sharing and learning platforms, document and share the lessons and feedback with the team", rating: "", comment: "" },
      { name: "Trend Tracking and Recommendations", description: "Track the modern and emerging trends in acceleration program delivery, best practices and provide recommendations on key developments to the Programs Director", rating: "", comment: "" }
    ],
  },
  {
    letter: "D", title: "INVESTMENT FACILITATION ACTIVITIES",
    objective: "To facilitate investment linkages, alumni engagement and represent the organization in investor networks.",
    kras: [
      { name: "Emerge Fund Linkages", description: "Coordinate linkages with Emerge Fund to support entrepreneurs in accessing the most suitable investment options", rating: "", comment: "" },
      { name: "Alumni and Talent Facilitation", description: "Facilitate alumni engagement and portfolio enterprises to recruit talent and raise capital financing on a need basis", rating: "", comment: "" },
      { name: "Investor Networking", description: "Represent Emerge Livelihoods and participate in in investor networking meetings, events and forums at national and international levels", rating: "", comment: "" }
    ],
  },
  {
    letter: "E", title: "PROGRAM REVIEWS, MONITORING, EVALUATION, ACCOUNTABILITY, PROGRAM LEARNING AND REPORTING",
    objective: "To monitor, review and report on acceleration programs to ensure learning, accountability and cost-effective achievement of objectives.",
    kras: [
      { name: "Work Plan Development and Monitoring", description: "Develop, monitor, review and update the acceleration programs activity work plan to ensure that it attains its objectives as cost effectively and efficiently as possible", rating: "", comment: "" },
      { name: "Resource Management", description: "Manage the expenditure and disbursement of resources allocated to the acceleration programs", rating: "", comment: "" },
      { name: "Performance Reporting", description: "Develop quality program performance reports ensuring learning and accountability on implementation progress", rating: "", comment: "" },
      { name: "Spending and Variance Monitoring", description: "Monitor and advise on program and project spending and variance report in accordance with the organisations process and procedures", rating: "", comment: "" }
    ],
  },
  {
    letter: "F", title: "POLICY MANAGEMENT AND COMPLIANCE",
    objective: "To develop, review, implement and ensure compliance with organizational policies and procedures.",
    kras: [
      { name: "Guidelines Development", description: "Support in the development and implementation of national specific guidelines for the management of partnerships in line with the Emerge Livelihoods Strategic Plan 2024-2029 and all relevant organizational policies", rating: "", comment: "" },
      { name: "Policy Review Participation", description: "Participate in the review and update of Emerge Livelihoods policies and procedures", rating: "", comment: "" },
      { name: "Policy Implementation", description: "Implement all necessary policies and procedures to ensure that correct procedures are adhered to in program delivery", rating: "", comment: "" },
      { name: "Organizational Compliance", description: "Comply and adhere with all approved organizational policies and procedures", rating: "", comment: "" }
    ],
  }
];
...
// ─── Main Form ────────────────────────────────────────────────────────────────
export default function IPAInvestmentPortfolioAnalystForm() {
  const [employeeId, setEmployeeId] = useState("");
  const [employeeName, setEmployeeName] = useState("");
  const [position, setPosition] = useState("Investment and Portfolio Analyst - Acceleration");
  ...
  const { clearDraft } = useFormDraft("ipa-investment-portfolio-analyst", {
    ...
    <div style={{ fontFamily: "Verdana, Geneva, sans-serif", color: "#222", background: "#f0f4f5", padding: "40px 24px 60px", minHeight: "100vh" }}>
      ...
      <div ref={formTopRef} className="af" style={{ maxWidth: 1050, margin: "0 auto", background: "#fff", border: "2px solid #4C808A", borderRadius: 8, padding: "40px 36px 48px", lineHeight: 1.45 }}>
        ...
        <div className="mh">
          ...
          <p className="subtitle">Investment and Portfolio Analyst - Acceleration</p>
        </div>
        ...
        <p className="ov">This 360-degree performance appraisal evaluates the Investment and Portfolio Analyst - Acceleration across six core dimensions derived from the role's responsibilities. The appraisal places strong emphasis on Program Planning, Management and Implementation; Recruitment, Selection and Portfolio Management; Acceleration and Investment Readiness; Investment Facilitation; MEAL and Reporting; and Policy Management and Compliance. It recognizes the critical role the position plays in amplifying MSME founders, implementing investment strategies and ensuring alignment with industry trends within Emerge Livelihoods.</p>
