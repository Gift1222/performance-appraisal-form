...
// ─── Main Form ────────────────────────────────────────────────────────────────
export default function TLLDETTeamLeaderLeadershipDevelopmentForm() {
  const [employeeId, setEmployeeId] = useState("");
  const [employeeName, setEmployeeName] = useState("");
  const [position, setPosition] = useState("Team Leader - Leadership Development, Education and Training (TL-LDET)");
  ...
  const { clearDraft } = useFormDraft("tl-ldet-team-leader-leadership-development", {
    ...
    <div style={{ fontFamily: "Verdana, Geneva, sans-serif", color: "#222", background: "#f0f4f5", padding: "40px 24px 60px", minHeight: "100vh" }}>
      ...
      <div ref={formTopRef} className="af" style={{ maxWidth: 1050, margin: "0 auto", background: "#fff", border: "2px solid #4C808A", borderRadius: 8, padding: "40px 36px 48px", lineHeight: 1.45 }}>
        ...
        <div className="mh">
          ...
          <p className="subtitle">Team Leader - Leadership Development, Education and Training</p>
        </div>
        ...
        <p className="ov">This 360-degree performance appraisal evaluates the Team Leader – Leadership Development, Education and Training (TL-LDET) across seven core dimensions derived from the role's scope of responsibilities. The appraisal places strong emphasis on Program Development, Program Management, Advocacy and Capacity Building, Partnerships and Resource Mobilization and Monitoring, Evaluation, Accountability and Learning (MEAL), recognizing their critical contribution to advancing Emerge Livelihoods' Strategic Plan 2024–2029.</p>
