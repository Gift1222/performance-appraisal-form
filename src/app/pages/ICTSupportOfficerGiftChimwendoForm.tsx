...
// ─── ICT Support Officer (Gift Chimwendo) dimension config ───────────────────
const INITIAL_DIMENSIONS: Dimension[] = [
  {
    letter: "A", title: "ICT PLANNING, MANAGEMENT AND IMPLEMENTATION",
    objective: "To effectively plan, coordinate and implement ICT activities that support organizational operations and strategic objectives.",
    kras: [
      { name: "ICT Operational Planning", description: "Develops and implements periodic ICT support and operational plans.", rating: "", comment: "" },
      { name: "ICT Project Implementation", description: "Supports implementation of ICT projects and digital transformation initiatives.", rating: "", comment: "" },
      { name: "Resource Planning and Coordination", description: "Coordinates ICT resources to ensure effective service delivery and business continuity.", rating: "", comment: "" },
      { name: "Technology Adoption Support", description: "Promotes adoption and utilization of digital technologies across the organization.", rating: "", comment: "" },
      { name: "Operational Performance Management", description: "Monitors achievement of ICT objectives, KPIs and work plans.", rating: "", comment: "" },
    ],
  },
  {
    letter: "B", title: "TECHNICAL SUPPORT AND SERVICE DELIVERY",
    objective: "To provide responsive, high-quality technical support that ensures optimal performance of ICT systems and services.",
    kras: [
      { name: "User Technical Support", description: "Provides timely and effective frontline support to users.", rating: "", comment: "" },
      { name: "Incident and Problem Resolution", description: "Diagnoses, troubleshoots and resolves ICT hardware, software and network issues.", rating: "", comment: "" },
      { name: "Service Continuity Management", description: "Minimizes downtime and ensures continuity of ICT services.", rating: "", comment: "" },
      { name: "Client-Centered Service Delivery", description: "Maintains high levels of customer satisfaction and responsiveness.", rating: "", comment: "" },
      { name: "ICT Support Documentation", description: "Maintains technical support records, manuals and troubleshooting guides.", rating: "", comment: "" },
    ],
  },
  {
    letter: "C", title: "ICT INFRASTRUCTURE, SYSTEMS AND ASSET MANAGEMENT",
    objective: "To maintain reliable ICT infrastructure, systems and technology assets that support organizational effectiveness.",
    kras: [
      { name: "Hardware and Software Management", description: "Maintains desktops, laptops, printers and organizational software systems.", rating: "", comment: "" },
      { name: "ICT Asset Management", description: "Tracks, maintains and safeguards ICT equipment and assets.", rating: "", comment: "" },
      { name: "Systems Administration", description: "Supports installation, configuration, maintenance and optimization of ICT systems.", rating: "", comment: "" },
      { name: "Preventive Maintenance", description: "Conducts routine maintenance and upgrades to ensure system reliability.", rating: "", comment: "" },
      { name: "ICT Resource Optimization", description: "Ensures effective utilization of ICT resources and technologies.", rating: "", comment: "" },
    ],
  },
  {
    letter: "D", title: "DIGITAL SYSTEMS, QUALITY ASSURANCE AND CONTINUOUS IMPROVEMENT",
    objective: "To strengthen ICT service quality, system performance and continuous improvement initiatives.",
    kras: [
      { name: "ICT Performance Monitoring", description: "Monitors and reports on ICT service performance and KPIs.", rating: "", comment: "" },
      { name: "Quality Assurance", description: "Promotes use of standardized ICT procedures, tools and quality standards.", rating: "", comment: "" },
      { name: "Process Improvement", description: "Identifies opportunities to improve ICT systems and support processes.", rating: "", comment: "" },
      { name: "Risk and Service Management", description: "Supports mitigation of ICT risks and reduction of service disruptions.", rating: "", comment: "" },
      { name: "Innovation and Digital Solutions", description: "Recommends and supports implementation of innovative technology solutions.", rating: "", comment: "" },
    ],
  },
  {
    letter: "E", title: "STAKEHOLDER SUPPORT, TEAMWORK AND COLLABORATION",
    objective: "To strengthen collaboration, stakeholder engagement and organizational technology support.",
    kras: [
      { name: "Stakeholder Relationship Management", description: "Maintains productive relationships with internal and external stakeholders.", rating: "", comment: "" },
      { name: "Team Collaboration", description: "Works collaboratively with ICT team members and other departments.", rating: "", comment: "" },
      { name: "Knowledge Sharing", description: "Shares technical knowledge and best practices across the organization.", rating: "", comment: "" },
      { name: "Backup and Operational Support", description: "Provides backup support for ICT operations when required.", rating: "", comment: "" },
      { name: "Capacity Building and User Guidance", description: "Supports user awareness and capacity building on ICT systems and tools.", rating: "", comment: "" },
    ],
  },
  {
    letter: "F", title: "POLICY MANAGEMENT, SECURITY AND COMPLIANCE",
    objective: "To ensure adherence to ICT policies, safeguarding principles, security standards and organizational procedures.",
    kras: [
      { name: "Policy Implementation", description: "Implements approved ICT policies, procedures and operational guidelines.", rating: "", comment: "" },
      { name: "ICT Governance and Compliance", description: "Ensures compliance with organizational ICT standards and controls.", rating: "", comment: "" },
      { name: "Information Security and Data Protection", description: "Promotes secure use of ICT systems and protection of organizational information.", rating: "", comment: "" },
      { name: "Safeguarding and Ethical Practice", description: "Upholds safeguarding, confidentiality, accountability and ethical standards.", rating: "", comment: "" },
      { name: "Policy Review and Improvement", description: "Participates in the review and improvement of ICT policies and procedures.", rating: "", comment: "" },
    ],
  },
];
...
// ─── Main Form ────────────────────────────────────────────────────────────────
export default function ICTSupportOfficerGiftChimwendoForm() {
  const [employeeId, setEmployeeId] = useState("");
  const [employeeName, setEmployeeName] = useState("");
  const [position, setPosition] = useState("ICT Support Officer - Gift Chimwendo");
  ...
  const { clearDraft } = useFormDraft("ict-support-officer-gift-chimwendo", {
  ...
  function resetForm() {
    setEmployeeId(""); setEmployeeName(""); setPosition("ICT Support Officer - Gift Chimwendo"); setReviewPeriod(""); setAppraisalDate(""); setReviewers("");
    ...
    <div style={{ fontFamily: "Verdana, Geneva, sans-serif", color: "#222", background: "#f0f4f5", padding: "40px 24px 60px", minHeight: "100vh" }}>
      ...
      <div ref={formTopRef} className="af" style={{ maxWidth: 1050, margin: "0 auto", background: "#fff", border: "2px solid #4C808A", borderRadius: 8, padding: "40px 36px 48px", lineHeight: 1.45 }}>
        ...
        <div className="mh">
          ...
          <p className="subtitle">ICT Support Officer (Gift Chimwendo)</p>
        </div>
        ...
        <p className="ov">This 360-degree performance appraisal evaluates the ICT Support Officer across six core dimensions derived from the role&rsquo;s responsibilities. The appraisal places strong emphasis on <strong>ICT Planning and Implementation, Technical Support and Service Delivery, Systems Administration, User Support and Policy Compliance</strong>, recognizing the critical role the position plays in ensuring reliable ICT infrastructure, effective user support, digital transformation and technology adoption across Emerge Livelihoods and its subsidiaries in support of the Strategic Plan 2024&ndash;2029.</p>
