...
// ─── MEAL Officer dimension config ────────────────────────────────────────────
const INITIAL_DIMENSIONS: Dimension[] = [
  {
    letter: "A", title: "MONITORING AND EVALUATION SYSTEM DESIGN AND IMPLEMENTATION",
    objective: "To support the development and implementation of effective monitoring and evaluation systems that measure program performance and impact.",
    kras: [
      { name: "MEAL Framework Development", description: "Supports development and implementation of project-specific MEAL frameworks, plans and tools.", rating: "", comment: "" },
      { name: "Data Collection Management", description: "Coordinates and oversees routine data collection activities ensuring quality and timeliness.", rating: "", comment: "" },
      { name: "Indicator Tracking and Performance Measurement", description: "Maintains indicator tracking systems and monitors achievement of project results.", rating: "", comment: "" },
      { name: "Data Analysis", description: "Conducts quantitative and qualitative analysis to assess outputs, outcomes and impact.", rating: "", comment: "" },
      { name: "Monitoring Reports and Dashboards", description: "Produces monitoring reports, dashboards and performance visualizations for decision-making.", rating: "", comment: "" },
    ],
  },
  {
    letter: "B", title: "ACCOUNTABILITY, LEARNING AND KNOWLEDGE MANAGEMENT",
    objective: "To strengthen accountability systems, organizational learning and knowledge management practices.",
    kras: [
      { name: "Complaints and Feedback Mechanism (CFM) Management", description: "Establishes and manages beneficiary feedback and complaint response systems.", rating: "", comment: "" },
      { name: "Accountability and Responsiveness", description: "Ensures stakeholder feedback is documented, analyzed and responded to appropriately.", rating: "", comment: "" },
      { name: "Learning Facilitation", description: "Supports learning and reflection sessions that promote adaptive management.", rating: "", comment: "" },
      { name: "Knowledge Management", description: "Maintains organized systems for storing and sharing MEAL data, reports and lessons learned.", rating: "", comment: "" },
      { name: "Documentation of Best Practices", description: "Documents success stories, lessons learned and case studies for organizational learning.", rating: "", comment: "" },
    ],
  },
  {
    letter: "C", title: "CAPACITY BUILDING AND COORDINATION",
    objective: "To strengthen staff and partner capacity in MEAL systems and promote integration of MEAL across projects.",
    kras: [
      { name: "Staff Capacity Building", description: "Supports training and mentoring of staff and partners on MEAL concepts and tools.", rating: "", comment: "" },
      { name: "Technical Support", description: "Provides technical guidance on data collection, analysis and reporting processes.", rating: "", comment: "" },
      { name: "Project Coordination", description: "Works closely with project teams to integrate MEAL throughout the project cycle.", rating: "", comment: "" },
      { name: "Stakeholder Engagement", description: "Supports engagement with evaluators, consultants and external stakeholders.", rating: "", comment: "" },
      { name: "Internal Collaboration", description: "Promotes collaboration between MEAL and program teams for improved results.", rating: "", comment: "" },
    ],
  },
  {
    letter: "D", title: "RESEARCH, ASSESSMENTS AND EVALUATIONS",
    objective: "To support evidence generation through research, assessments, surveys and evaluations.",
    kras: [
      { name: "Desk Research and Context Analysis", description: "Conducts literature reviews, secondary data analysis and benchmarking studies.", rating: "", comment: "" },
      { name: "Baseline, Midline and Endline Assessments", description: "Supports planning and implementation of surveys and project evaluations.", rating: "", comment: "" },
      { name: "Needs Assessments and Studies", description: "Supports research initiatives that inform program design and adaptation.", rating: "", comment: "" },
      { name: "GIS and Technology Integration", description: "Supports integration of GIS and technology-based approaches in project implementation.", rating: "", comment: "" },
      { name: "Evaluation Support", description: "Provides logistical and operational support for internal and external evaluations.", rating: "", comment: "" },
    ],
  },
  {
    letter: "E", title: "DATA MANAGEMENT AND VISUALIZATION",
    objective: "To ensure accurate, secure and effective management of project data and visualization systems.",
    kras: [
      { name: "Database Management", description: "Maintains project databases and ensures accurate data entry, storage and accessibility.", rating: "", comment: "" },
      { name: "Data Quality Assurance", description: "Conducts routine data validation, cleaning, verification and quality control checks.", rating: "", comment: "" },
      { name: "Data Security and Confidentiality", description: "Ensures compliance with data protection, confidentiality and security standards.", rating: "", comment: "" },
      { name: "Data Analysis and Visualization", description: "Produces data summaries, visualizations, dashboards and analytical outputs.", rating: "", comment: "" },
      { name: "Performance Tracking Systems", description: "Maintains and updates project performance monitoring tools and dashboards.", rating: "", comment: "" },
    ],
  },
  {
    letter: "F", title: "REPORTING AND COMPLIANCE",
    objective: "To ensure accurate, timely and quality reporting that meets organizational and donor requirements.",
    kras: [
      { name: "Routine Program Reporting", description: "Compiles and submits monthly, quarterly and periodic project reports.", rating: "", comment: "" },
      { name: "Donor Reporting Support", description: "Provides verified data, narratives and visualizations for donor reports.", rating: "", comment: "" },
      { name: "Case Studies and Success Stories", description: "Documents project impact through stories, case studies and qualitative evidence.", rating: "", comment: "" },
      { name: "Accountability Reporting", description: "Consolidates and reports findings from complaints and feedback systems.", rating: "", comment: "" },
      { name: "Reporting Quality Assurance", description: "Ensures reports meet organizational and donor quality standards.", rating: "", comment: "" },
    ],
  },
  {
    ...
    kras: [
      { name: "Policy Implementation", description: "Implements approved organizational policies, procedures and MEAL standards.", rating: "", comment: "" },
      { name: "Safeguarding, Child Protection and GESI", description: "Promotes safeguarding, child protection, gender equality and social inclusion principles.", rating: "", comment: "" },
      { name: "Compliance Management", description: "Ensures compliance with donor requirements, audits and organizational guidelines.", rating: "", comment: "" },
      { name: "Health and Safety Compliance", description: "Supports implementation of workplace health and safety standards.", rating: "", comment: "" },
      { name: "Ethics and Professional Conduct", description: "Upholds confidentiality, integrity, accountability and professional ethics.", rating: "", comment: "" },
    ],
  },
];
...
// ─── Main Form ────────────────────────────────────────────────────────────────
export default function MEALOfficerForm() {
  const [employeeId, setEmployeeId] = useState("");
  const [employeeName, setEmployeeName] = useState("");
  const [position, setPosition] = useState("MEAL Officer");
  ...
  const { clearDraft } = useFormDraft("meal-officer", {
  ...
  useEffect(() => {
    document.title = "MEAL Officer Performance Appraisal Form";
  ...
  function resetForm() {
    setEmployeeId(""); setEmployeeName(""); setPosition("MEAL Officer"); setReviewPeriod(""); setAppraisalDate(""); setReviewers("");
    ...
    <div style={{ fontFamily: "Verdana, Geneva, sans-serif", color: "#222", background: "#f0f4f5", padding: "40px 24px 60px", minHeight: "100vh" }}>
      ...
      <div ref={formTopRef} className="af" style={{ maxWidth: 1050, margin: "0 auto", background: "#fff", border: "2px solid #4C808A", borderRadius: 8, padding: "40px 36px 48px", lineHeight: 1.45 }}>
        ...
        <div className="mh">
          ...
          <p className="subtitle">MEAL Officer</p>
        </div>
        ...
        <p className="ov">This 360-degree performance appraisal evaluates the Monitoring, Evaluation, Accountability and Learning (MEAL) Officer across seven core dimensions derived from the role&rsquo;s responsibilities. The appraisal places strong emphasis on <strong>Monitoring and Evaluation Systems, Data Management and Visualization, Accountability and Learning, Research and Reporting and Compliance</strong>, recognizing their critical role in generating evidence, measuring program performance, strengthening accountability and supporting data-driven decision-making in line with Emerge Livelihoods&rsquo; Strategic Plan 2024&ndash;2029.</p>
