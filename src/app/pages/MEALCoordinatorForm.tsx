...
// ─── MEAL Coordinator dimension config ────────────────────────────────────────
const INITIAL_DIMENSIONS: Dimension[] = [
  {
    letter: "A", title: "PROGRAM PLANNING, MANAGEMENT AND TECHNICAL QUALITY",
    objective: "To provide strategic leadership and technical oversight for the development, implementation and continuous improvement of organizational MEAL systems.",
    kras: [
      { name: "MEAL Systems Development", description: "Establishes and strengthens organizational MEAL systems, frameworks, procedures and tools.", rating: "", comment: "" },
      { name: "Technical Quality Assurance", description: "Ensures programs meet organizational monitoring, evaluation and data quality standards.", rating: "", comment: "" },
      { name: "Data Quality Management", description: "Oversees data quality audits, verification processes and continuous improvement initiatives.", rating: "", comment: "" },
      { name: "Gender-Sensitive MEAL Integration", description: "Ensures gender-sensitive approaches are integrated into data collection, analysis and reporting.", rating: "", comment: "" },
      { name: "Program Monitoring Support", description: "Provides technical support for planning, implementation, monitoring and reporting processes.", rating: "", comment: "" },
    ],
  },
  {
    letter: "B", title: "PROGRAM DEVELOPMENT AND RESOURCE PLANNING",
    objective: "To support program growth, proposal development and integration of effective MEAL systems into new and existing programs.",
    kras: [
      { name: "Proposal Development Support", description: "Leads development and review of logical frameworks, indicators and measurement plans.", rating: "", comment: "" },
      { name: "Indicator and Results Framework Development", description: "Ensures alignment of project indicators with organizational strategic indicators.", rating: "", comment: "" },
      { name: "MEAL Budget Planning", description: "Develops and manages MEAL operational budgets and resource requirements.", rating: "", comment: "" },
      { name: "Program Design Support", description: "Supports program teams in integrating MEAL requirements into project design.", rating: "", comment: "" },
      { name: "Resource Mobilization Support", description: "Provides technical inputs to funding proposals and donor submissions.", rating: "", comment: "" },
    ],
  },
  {
    letter: "C", title: "STAFF PERFORMANCE MANAGEMENT AND ACCOUNTABILITY",
    objective: "To develop, supervise and strengthen the performance of MEAL staff while promoting accountability and safeguarding.",
    kras: [
      { name: "Team Leadership and Supervision", description: "Provides leadership, direction and supervision to MEAL Officers and team members.", rating: "", comment: "" },
      { name: "Staff Capacity Development", description: "Coaches, mentors and builds technical and professional competencies of staff.", rating: "", comment: "" },
      { name: "Performance Management", description: "Supports objective setting, performance reviews, feedback and staff development planning.", rating: "", comment: "" },
      { name: "Accountability Systems Management", description: "Oversees complaints, feedback mechanisms and accountability processes.", rating: "", comment: "" },
      { name: "Safeguarding Integration", description: "Ensures safeguarding principles are embedded in accountability systems and program implementation.", rating: "", comment: "" },
    ],
  },
  {
    letter: "D", title: "ICT, DIGITAL SYSTEMS AND NETWORKING",
    objective: "To strengthen digital MEAL systems, information management, networking and stakeholder engagement.",
    kras: [
      { name: "Digital Data Management Systems", description: "Supports implementation and enhancement of digital data collection and management platforms.", rating: "", comment: "" },
      { name: "GIS and Technology Integration", description: "Promotes use of GIS and technology-driven reporting systems.", rating: "", comment: "" },
      { name: "Management Information Systems", description: "Strengthens program management information systems and reporting infrastructure.", rating: "", comment: "" },
      { name: "Stakeholder Relationship Management", description: "Maintains productive relationships with government, partners, donors and networks.", rating: "", comment: "" },
      { name: "External Representation and Networking", description: "Represents the organization in technical forums, networks and stakeholder engagements.", rating: "", comment: "" },
    ],
  },
  {
    letter: "E", title: "STRATEGY, LEARNING AND ORGANIZATIONAL CULTURE CHANGE",
    objective: "To foster a culture of evidence-based decision-making, learning, innovation and adaptive management.",
    kras: [
      { name: "Organizational Learning Leadership", description: "Promotes learning, reflection and utilization of evidence for program improvement.", rating: "", comment: "" },
      { name: "Data-Driven Decision Making", description: "Strengthens organizational use of data for planning, adaptation and decision-making.", rating: "", comment: "" },
      { name: "Knowledge Management", description: "Facilitates documentation and dissemination of lessons learned and best practices.", rating: "", comment: "" },
      { name: "Context and Feedback Analysis", description: "Promotes utilization of beneficiary feedback, contextual analysis and environmental scanning.", rating: "", comment: "" },
      { name: "Strategic Performance Measurement", description: "Ensures consistency of indicators and measurement systems across programs.", rating: "", comment: "" },
    ],
  },
  {
    letter: "F", title: "REPORTING, DATA QUALITY AND RESULTS MANAGEMENT",
    objective: "To ensure high-quality reporting, performance measurement and results management across programs.",
    kras: [
      { name: "Results Monitoring and Tracking", description: "Oversees monitoring of outputs, outcomes and organizational performance indicators.", rating: "", comment: "" },
      { name: "Donor Reporting Support", description: "Ensures donor reports meet quality standards and reporting requirements.", rating: "", comment: "" },
      { name: "Data Analysis and Visualization", description: "Oversees analysis, interpretation and visualization of organizational data.", rating: "", comment: "" },
      { name: "Impact Measurement", description: "Supports evaluations, assessments and measurement of program effectiveness and impact.", rating: "", comment: "" },
      { name: "Reporting Quality Assurance", description: "Reviews reports to ensure accuracy, completeness and compliance.", rating: "", comment: "" },
    ],
  },
  {
    letter: "G", title: "POLICY MANAGEMENT, COMPLIANCE AND GOVERNANCE",
    objective: "To ensure adherence to organizational policies, donor requirements and governance standards.",
    kras: [
      { name: "Policy Implementation", description: "Ensures implementation of approved organizational policies and procedures.", rating: "", comment: "" },
      { name: "Policy Review and Improvement", description: "Participates in review and strengthening of organizational policies and systems.", rating: "", comment: "" },
      { name: "Compliance Management", description: "Ensures compliance with donor, legal, audit and organizational requirements.", rating: "", comment: "" },
      { name: "Risk Management and Governance", description: "Supports accountability, transparency and organizational governance processes.", rating: "", comment: "" },
      { name: "Ethics and Professional Conduct", description: "Upholds integrity, confidentiality, safeguarding and professional standards.", rating: "", comment: "" },
    ],
  },
];
...
// ─── Main Form ────────────────────────────────────────────────────────────────
export default function MEALCoordinatorForm() {
  const [employeeId, setEmployeeId] = useState("");
  const [employeeName, setEmployeeName] = useState("");
  const [position, setPosition] = useState("MEAL Coordinator");
  ...
  const { clearDraft } = useFormDraft("meal-coordinator", {
  ...
  function resetForm() {
    setEmployeeId(""); setEmployeeName(""); setPosition("MEAL Coordinator"); setReviewPeriod(""); setAppraisalDate(""); setReviewers("");
    ...
    <div style={{ fontFamily: "Verdana, Geneva, sans-serif", color: "#222", background: "#f0f4f5", padding: "40px 24px 60px", minHeight: "100vh" }}>
      ...
      <div ref={formTopRef} className="af" style={{ maxWidth: 1050, margin: "0 auto", background: "#fff", border: "2px solid #4C808A", borderRadius: 8, padding: "40px 36px 48px", lineHeight: 1.45 }}>
        ...
        <div className="mh">
          ...
          <p className="subtitle">MEAL Coordinator</p>
        </div>
        ...
        <p className="ov">This 360-degree performance appraisal evaluates the Monitoring, Evaluation, Accountability and Learning (MEAL) Coordinator across seven core dimensions derived from the role&rsquo;s responsibilities. The appraisal places strong emphasis on <strong>Program Planning, Management and Technical Quality, Program Development, Staff Performance Management, Data Quality Assurance, Organizational Learning and Strategic MEAL Leadership</strong>, recognizing the critical role the position plays in strengthening evidence-based decision-making, accountability, learning and organizational performance in support of Emerge Livelihoods&rsquo; Strategic Plan 2024&ndash;2029.</p>
