...
const INITIAL_DIMENSIONS: Dimension[] = [
  {
    letter: "A", title: "TECHNICAL OPERATIONS STRATEGY AND DIGITAL TRANSFORMATION",
    objective: "To provide strategic leadership in the development and implementation of technical operations and digital transformation initiatives.",
    kras: [
      { name: "Technical Operations Strategy Development", description: "Leads development and implementation of technical operations strategies aligned with organizational objectives.", rating: "", comment: "" },
      { name: "Digital Inclusion and Innovation", description: "Promotes digital inclusion and adoption of innovative technology solutions across programs and operations.", rating: "", comment: "" },
      { name: "Strategic Advisory Services", description: "Provides technical advice and strategic guidance to management and stakeholders.", rating: "", comment: "" },
      { name: "Service User Feedback and Improvement", description: "Collects, analyzes and utilizes stakeholder feedback to improve services and operational performance.", rating: "", comment: "" },
      { name: "Sustainability Integration", description: "Integrates environmental sustainability considerations into technical operations and decision-making.", rating: "", comment: "" },
    ],
  },
  {
    letter: "B", title: "TECHNICAL INFRASTRUCTURE, RESOURCE AND FACILITIES MANAGEMENT",
    objective: "To ensure effective management and optimization of technical infrastructure, systems, facilities and resources.",
    kras: [
      { name: "Technical Infrastructure Management", description: "Oversees development, maintenance and optimization of technical infrastructure and systems.", rating: "", comment: "" },
      { name: "Resource Planning and Allocation", description: "Coordinates technical resources, facilities, equipment and budgets efficiently.", rating: "", comment: "" },
      { name: "Facilities and Learning Environment Support", description: "Supports development of facilities and technology resources for education and training activities.", rating: "", comment: "" },
      { name: "Technology Assessment and Improvement", description: "Identifies opportunities for improvement and modernization of technical resources.", rating: "", comment: "" },
      { name: "Asset and Equipment Management", description: "Oversees procurement, maintenance and lifecycle management of ICT equipment and assets.", rating: "", comment: "" },
    ],
  },
  {
    letter: "C", title: "TECHNICAL OPERATIONS, SERVICE DELIVERY AND QUALITY ASSURANCE",
    objective: "To ensure efficient, high-quality and compliant technical service delivery across the organization.",
    kras: [
      { name: "Service Delivery Management", description: "Ensures technical services are delivered effectively, efficiently and consistently.", rating: "", comment: "" },
      { name: "Quality Assurance and Standards Compliance", description: "Promotes adherence to technical standards, procedures and service quality requirements.", rating: "", comment: "" },
      { name: "Performance Monitoring and KPI Management", description: "Monitors technical operations performance and achievement of departmental objectives.", rating: "", comment: "" },
      { name: "Risk Management and Service Continuity", description: "Identifies and mitigates operational risks while ensuring business continuity.", rating: "", comment: "" },
      { name: "Data Protection and Compliance", description: "Ensures compliance with data protection regulations and operational controls.", rating: "", comment: "" },
    ],
  },
  {
    letter: "D", title: "TEAM LEADERSHIP, PERFORMANCE MANAGEMENT AND CAPACITY BUILDING",
    objective: "To build and sustain a high-performing technical operations team.",
    kras: [
      { name: "Team Leadership and Supervision", description: "Provides leadership, direction and oversight to ICT Support Officers and technical teams.", rating: "", comment: "" },
      { name: "Staff Performance Management", description: "Conducts performance planning, coaching, feedback and reviews.", rating: "", comment: "" },
      { name: "Staff Development and Capacity Building", description: "Supports technical, professional and leadership development of staff.", rating: "", comment: "" },
      { name: "Workforce Planning and Resource Coordination", description: "Ensures adequate staffing and efficient deployment of technical personnel.", rating: "", comment: "" },
      { name: "Team Engagement and Collaboration", description: "Promotes teamwork, accountability, communication and a positive work culture.", rating: "", comment: "" },
    ],
  },
  {
    letter: "E", title: "PARTNERSHIPS, NETWORKS AND STAKEHOLDER ENGAGEMENT",
    objective: "To strengthen partnerships, collaboration and stakeholder relationships that support technical operations and innovation.",
    kras: [
      { name: "Partnership Development", description: "Builds and maintains strategic relationships with technology partners and service providers.", rating: "", comment: "" },
      { name: "Network Engagement", description: "Represents the organization in professional networks, forums and industry platforms.", rating: "", comment: "" },
      { name: "Stakeholder Relationship Management", description: "Maintains productive engagement with internal and external stakeholders.", rating: "", comment: "" },
      { name: "Technology Adoption Support", description: "Coordinates technology utilization reviews and supports organizational adoption initiatives.", rating: "", comment: "" },
      { name: "Supplier and Vendor Management", description: "Develops and manages relationships with suppliers and outsourced partners.", rating: "", comment: "" },
    ],
  },
  {
    letter: "F", title: "RESEARCH, INNOVATION AND CONTINUOUS IMPROVEMENT",
    objective: "To drive innovation, technology advancement and continuous improvement across technical operations.",
    kras: [
      { name: "Technology Research and Development", description: "Monitors emerging technologies and identifies opportunities for organizational application.", rating: "", comment: "" },
      { name: "Innovation Management", description: "Promotes innovative approaches that improve efficiency and service delivery.", rating: "", comment: "" },
      { name: "Systems Improvement", description: "Recommends and implements improvements to systems, processes and infrastructure.", rating: "", comment: "" },
      { name: "Organizational Learning", description: "Facilitates knowledge sharing and application of lessons learned across technical operations.", rating: "", comment: "" },
      { name: "Future Resource Planning", description: "Identifies future technical resource requirements and organizational technology needs.", rating: "", comment: "" },
    ],
  },
  {
    letter: "G", title: "POLICY MANAGEMENT, SAFEGUARDING AND COMPLIANCE",
    objective: "To ensure compliance with organizational policies, safeguarding standards and regulatory requirements.",
    kras: [
      { name: "Policy Development and Implementation", description: "Supports development, implementation and enforcement of ICT policies and procedures.", rating: "", comment: "" },
      { name: "Governance and Compliance", description: "Ensures compliance with organizational standards, legal requirements and audit recommendations.", rating: "", comment: "" },
      { name: "Safeguarding and Inclusion", description: "Promotes safeguarding, GESI and protection standards across technical operations.", rating: "", comment: "" },
      { name: "Risk and Control Management", description: "Implements controls that reduce operational and compliance risks.", rating: "", comment: "" },
      { name: "Ethics and Professional Conduct", description: "Upholds organizational values, accountability, integrity and professionalism.", rating: "", comment: "" },
    ],
  },
];
...
// ─── Main Form ────────────────────────────────────────────────────────────────
export default function TLTOTeamLeaderTechnicalOperationsForm() {
  const [employeeId, setEmployeeId] = useState("");
  const [employeeName, setEmployeeName] = useState("");
  const [position, setPosition] = useState("Team Leader - Technical Operations (TL-TO)");
    ...
    <div style={{ fontFamily: "Verdana, Geneva, sans-serif", color: "#222", background: "#f0f4f5", padding: "40px 24px 60px", minHeight: "100vh" }}>
      ...
      <div ref={formTopRef} className="af" style={{ maxWidth: 1050, margin: "0 auto", background: "#fff", border: "2px solid #4C808A", borderRadius: 8, padding: "40px 36px 48px", lineHeight: 1.45 }}>
        ...
        <div className="mh">
          ...
          <p className="subtitle">Team Leader - Technical Operations</p>
        </div>
        ...
        <p className="ov">This 360-degree performance appraisal evaluates the Team Leader – Technical Operations (TL-TO) across seven core dimensions derived from the role's responsibilities. The appraisal places strong emphasis on Technical Operations Strategy, Infrastructure Management, Service Delivery, Digital Inclusion, Partnerships and Networking and Team Leadership, recognizing the critical role the position plays in driving organizational digital transformation, technical excellence, innovation and operational effectiveness across Emerge Livelihoods and its subsidiaries in support of the Strategic Plan 2024–2029.</p>
