...
// ─── Programmes Director dimension config ────────────────────────────────────
const INITIAL_DIMENSIONS: Dimension[] = [
  {
    letter: "A", title: "PROGRAM PLANNING, MANAGEMENT AND IMPLEMENTATION",
    objective: "To ensure the effective leadership, strategic alignment and quality implementation of all programs under Emerge Livelihoods.",
    kras: [
      { name: "Strategic Leadership", description: "Provides leadership in developing strategy and budgets aligned with the Emerge Livelihoods Strategic Plan 2024–2029.", rating: "", comment: "" },
      { name: "Operational Planning", description: "Supports the Managing Director in developing strategic and operational plans based on strategic guidelines.", rating: "", comment: "" },
      { name: "Program Alignment", description: "Reviews and ensures alignment of program priorities, strategies and plans with core organisational strategy and the localization strategy.", rating: "", comment: "" },
      { name: "Implementation Quality", description: "Ensures quality and effective implementation of all projects, demonstrating value for money and return on investment.", rating: "", comment: "" },
      { name: "Knowledge Management", description: "Ensures all learning and knowledge is documented effectively by the programs team.", rating: "", comment: "" },
    ],
  },
  {
    letter: "B", title: "FUNDRAISING AND DONOR RELATIONSHIP MANAGEMENT",
    objective: "To drive resource mobilization by developing and managing relationships with funding partners and creating high-quality, participatory grant proposals.",
    kras: [
      { name: "Donor Relationship Management", description: "Supports the development and management of strong relationships with local and international funding partners.", rating: "", comment: "" },
      { name: "Proposal Development", description: "Leads the development of program ideas and concepts into quality grant proposals using a participatory community approach.", rating: "", comment: "" },
      { name: "Resource Mobilization", description: "Collaborates with the Partnership and Resource Development Department to respond to diverse funding opportunities.", rating: "", comment: "" },
    ],
  },
  {
    letter: "C", title: "PROGRAM REVIEWS, MONITORING, EVALUATION AND LEARNING",
    objective: "To ensure robust monitoring, evaluation, accountability and learning systems are in place to track progress, ensure compliance and promote evidence-based decision-making.",
    kras: [
      { name: "Monitoring and Evaluation", description: "Ensures close monitoring of all program activities to track information flow and the systematic documentation of achievements and lessons learned.", rating: "", comment: "" },
      { name: "Reporting", description: "Ensures timely and quality submission of quarterly, bi-annual and annual program reports according to desired standards.", rating: "", comment: "" },
      { name: "Compliance", description: "Ensures adequate compliance with approved program/project plans and organizational policies.", rating: "", comment: "" },
      { name: "Evidence-Based Learning", description: "Promotes evidence-based learning, documents lessons and represents Emerge Livelihoods in knowledge-sharing platforms.", rating: "", comment: "" },
    ],
  },
  {
    letter: "D", title: "PARTNERSHIPS AND NETWORK",
    objective: "To strengthen, manage and leverage networks and partnerships to enhance the impact and reach of Emerge Livelihoods’ work.",
    kras: [
      { name: "Network Strengthening", description: "Supports Program Managers in strengthening networks and rapport with key strategic networks and consortiums.", rating: "", comment: "" },
      { name: "Representation", description: "Represents Emerge Livelihoods in network meetings, events and forums at national and international levels.", rating: "", comment: "" },
      { name: "Partnership Management", description: "Ensures effective partnerships at all levels per organizational standards and coordinates partnership reviews.", rating: "", comment: "" },
      { name: "Collaboration", description: "Ensures effective information flow with other key stakeholders, including subsidiary teams (Emerge Fund, Emerge Ventures) and academia.", rating: "", comment: "" },
    ],
  },
  {
    letter: "E", title: "FINANCIAL MANAGEMENT",
    objective: "To manage the department’s financial resources effectively and efficiently, ensuring alignment with budgets and policies.",
    kras: [
      { name: "Budgeting and Planning", description: "Develops, monitors, reviews and updates the programs department activity and work plan to ensure cost-effective attainment of objectives.", rating: "", comment: "" },
      { name: "Expenditure Management", description: "Manages the expenditure and disbursement of resources allocated to the program department.", rating: "", comment: "" },
      { name: "Financial Review", description: "Reviews program concepts and financial requests to ensure alignment with financial management policies.", rating: "", comment: "" },
      { name: "Monitoring and Reporting", description: "Monitors and advises on program spending and variance reports in accordance with organizational procedures.", rating: "", comment: "" },
    ],
  },
  {
    letter: "F", title: "HUMAN RESOURCE MANAGEMENT",
    objective: "To lead, manage and develop the programs team to achieve its goals in a motivating and empowering environment.",
    kras: [
      { name: "Team Leadership and Management", description: "Leads and manages the program team to achieve mandated goals according to annual operational plans.", rating: "", comment: "" },
      { name: "Staff Development", description: "Provides induction, training, coaching and mentoring; identifies training needs and development opportunities in collaboration with People and Culture.", rating: "", comment: "" },
      { name: "Performance Management", description: "Assigns performance goals, conducts comprehensive performance appraisals and provides feedback to team members.", rating: "", comment: "" },
      { name: "Work Environment", description: "Ensures an empowering and motivating work environment incorporating team building and core values.", rating: "", comment: "" },
      { name: "Recruitment and Onboarding", description: "Participates in the recruitment of staff and review of job descriptions under the supervision of the People and Culture department.", rating: "", comment: "" },
    ],
  },
  {
    letter: "G", title: "POLICY MANAGEMENT AND COMPLIANCE",
    objective: "To ensure adherence to all organizational policies and procedures and to contribute to their development and review.",
    kras: [
      { name: "Policy Development", description: "Leads the development and implementation of national-specific guidelines for partnership management.", rating: "", comment: "" },
      { name: "Policy Compliance", description: "Implements all necessary policies and procedures and ensures they are adhered to by the programs team.", rating: "", comment: "" },
      { name: "Advisory Role", description: "Participates in the review and update of policies and advises the Senior Management Team on implications of new policies.", rating: "", comment: "" },
    ],
  },
];
...
// ─── Main Form ────────────────────────────────────────────────────────────────
export default function ProgramsDirectorForm() {
  const [employeeId, setEmployeeId] = useState("");
  const [employeeName, setEmployeeName] = useState("");
  const [position, setPosition] = useState("Programs Director");
  ...
  const { clearDraft } = useFormDraft("programs-director", {
  ...
  function resetForm() {
    setEmployeeId(""); setEmployeeName(""); setPosition("Programs Director"); setReviewPeriod(""); setAppraisalDate(""); setReviewers("");
    ...
    <div style={{ fontFamily: "Verdana, Geneva, sans-serif", color: "#222", background: "#f0f4f5", padding: "40px 24px 60px", minHeight: "100vh" }}>
      ...
      <div ref={formTopRef} className="af" style={{ maxWidth: 1050, margin: "0 auto", background: "#fff", border: "2px solid #4C808A", borderRadius: 8, padding: "40px 36px 48px", lineHeight: 1.45 }}>
        ...
        <div className="mh">
          ...
          <p className="subtitle">Programs Director</p>
        </div>
        ...
        <p className="ov">This 360-degree performance appraisal evaluates the Programs Director across five core dimensions derived from the role&rsquo;s scope of responsibilities. It places strong emphasis on <strong>Program Management, Fundraising and Strategic Leadership</strong>, recognizing their critical role in driving the success of Emerge Livelihoods&rsquo; Strategy 2024&ndash;2029.</p>
