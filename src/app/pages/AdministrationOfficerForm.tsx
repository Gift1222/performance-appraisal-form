...
// ─── Administration Officer dimension config ─────────────────────────────────
const INITIAL_DIMENSIONS: Dimension[] = [
  {
    letter: "A", title: "ADMINISTRATIVE PLANNING, MANAGEMENT AND IMPLEMENTATION",
    objective: "To ensure effective planning, coordination and implementation of administrative activities that support organizational operations.",
    kras: [
      { name: "Administrative Planning", description: "Supports development and implementation of administrative strategies, plans and workplans.", rating: "", comment: "" },
      { name: "Operational Coordination", description: "Ensures effective execution of administrative activities and achievement of departmental objectives.", rating: "", comment: "" },
      { name: "Strategic Alignment", description: "Ensures administration priorities and activities align with organizational goals and stakeholder needs.", rating: "", comment: "" },
      { name: "Knowledge Management", description: "Maintains effective documentation, recordkeeping and organizational learning systems.", rating: "", comment: "" },
      { name: "Service Delivery Excellence", description: "Ensures quality, efficiency and value for money in administration services.", rating: "", comment: "" },
    ],
  },
  {
    letter: "B", title: "STAKEHOLDER PORTFOLIO MANAGEMENT",
    objective: "To effectively manage relationships with stakeholders, visitors, service providers and partners while ensuring excellent customer service.",
    kras: [
      { name: "Stakeholder Relationship Management", description: "Develops and maintains productive relationships with key stakeholders and service providers.", rating: "", comment: "" },
      { name: "Front Office Management", description: "Ensures professional reception services and effective handling of visitors and inquiries.", rating: "", comment: "" },
      { name: "Customer Service Excellence", description: "Provides timely, professional and responsive administrative support to internal and external stakeholders.", rating: "", comment: "" },
      { name: "Service Provider Coordination", description: "Maintains an updated database and pipeline of suppliers and service providers.", rating: "", comment: "" },
      { name: "Administrative Support Services", description: "Coordinates travel, logistics, information packs and administrative resources.", rating: "", comment: "" },
    ],
  },
  {
    letter: "C", title: "MEETING MANAGEMENT AND GOVERNANCE SUPPORT",
    objective: "To coordinate effective meetings, events, governance processes and organizational communications.",
    kras: [
      { name: "Meeting Coordination", description: "Plans, organizes and coordinates staff, management, board and program meetings.", rating: "", comment: "" },
      { name: "Governance Support", description: "Supports board and management governance processes through scheduling and documentation.", rating: "", comment: "" },
      { name: "Event and Retreat Management", description: "Coordinates staff retreats, workshops and organizational events effectively.", rating: "", comment: "" },
      { name: "Recruitment Administration Support", description: "Provides administrative support during recruitment and onboarding processes.", rating: "", comment: "" },
      { name: "Reporting and Communication", description: "Ensures timely preparation and dissemination of meeting reports and supporting documents.", rating: "", comment: "" },
    ],
  },
  {
    letter: "D", title: "OFFICE ENVIRONMENT, HEALTH, SAFETY AND SECURITY MANAGEMENT",
    objective: "To maintain a safe, clean, secure and productive working environment.",
    kras: [
      { name: "Office Environment Management", description: "Maintains a clean, organized and environmentally sustainable workplace.", rating: "", comment: "" },
      { name: "Health and Safety Compliance", description: "Ensures adherence to workplace health and safety standards and procedures.", rating: "", comment: "" },
      { name: "Security Management", description: "Supervises security personnel and supports workplace security initiatives.", rating: "", comment: "" },
      { name: "Facilities and Asset Support", description: "Ensures office facilities and equipment support efficient operations.", rating: "", comment: "" },
      { name: "Grievance and Complaint Management", description: "Addresses office-related complaints and concerns promptly and professionally.", rating: "", comment: "" },
    ],
  },
  {
    letter: "E", title: "ADMINISTRATIVE MONITORING, EVALUATION, ACCOUNTABILITY, LEARNING AND REPORTING",
    objective: "To ensure effective monitoring, accountability, learning, resource utilization and reporting of administrative functions.",
    kras: [
      { name: "Workplan Management", description: "Develops, monitors, reviews and updates administrative workplans.", rating: "", comment: "" },
      { name: "Resource and Budget Management", description: "Manages allocated administrative resources efficiently and responsibly.", rating: "", comment: "" },
      { name: "Performance Monitoring", description: "Tracks administrative performance indicators and service delivery standards.", rating: "", comment: "" },
      { name: "Reporting and Accountability", description: "Produces quality administrative reports and ensures accountability for results.", rating: "", comment: "" },
      { name: "Continuous Improvement and Learning", description: "Promotes learning, innovation and improvements in administrative processes.", rating: "", comment: "" },
    ],
  },
  {
    letter: "F", title: "POLICY MANAGEMENT AND COMPLIANCE",
    objective: "To ensure adherence to organizational policies, procedures, standards and regulatory requirements.",
    kras: [
      { name: "Policy Implementation", description: "Implements approved administrative policies, procedures and guidelines.", rating: "", comment: "" },
      { name: "Policy Review and Improvement", description: "Participates in policy review and organizational improvement initiatives.", rating: "", comment: "" },
      { name: "Compliance Management", description: "Ensures compliance with organizational standards and administrative requirements.", rating: "", comment: "" },
      { name: "Ethics and Professional Conduct", description: "Upholds organizational values, confidentiality, accountability and professional ethics.", rating: "", comment: "" },
    ],
  },
];
...
// ─── Main Form ────────────────────────────────────────────────────────────────
export default function AdministrationOfficerForm() {
  const [employeeId, setEmployeeId] = useState("");
  const [employeeName, setEmployeeName] = useState("");
  const [position, setPosition] = useState("Administration Officer");
  ...
  const { clearDraft } = useFormDraft("administration-officer", {
  ...
  function resetForm() {
    setEmployeeId(""); setEmployeeName(""); setPosition("Administration Officer"); setReviewPeriod(""); setAppraisalDate(""); setReviewers("");
    ...
    <div style={{ fontFamily: "Verdana, Geneva, sans-serif", color: "#222", background: "#f0f4f5", padding: "40px 24px 60px", minHeight: "100vh" }}>
      ...
      <div ref={formTopRef} className="af" style={{ maxWidth: 1050, margin: "0 auto", background: "#fff", border: "2px solid #4C808A", borderRadius: 8, padding: "40px 36px 48px", lineHeight: 1.45 }}>
        ...
        <div className="mh">
          ...
          <p className="subtitle">Administration Officer</p>
        </div>
        ...
        <p className="ov">This 360-degree performance appraisal evaluates the Administration Officer across six core dimensions derived from the role&rsquo;s scope of responsibilities. The appraisal places strong emphasis on <strong>Administrative Planning and Management, Stakeholder Portfolio Management, Meeting Management and Office Environment Management</strong>, recognizing their critical role in ensuring efficient organizational operations, effective stakeholder engagement and a productive work environment in support of Emerge Livelihoods&rsquo; Strategic Plan 2024&ndash;2029.</p>
