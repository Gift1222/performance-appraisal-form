...
// ─── TL-CM dimension config ──────────────────────────────────────────────────
const INITIAL_DIMENSIONS: Dimension[] = [
  {
    letter: "A", title: "COMMUNICATIONS AND MARKETING STRATEGY DEVELOPMENT",
    objective: "To provide strategic leadership in the development and implementation of communication and marketing initiatives that advance organizational goals.",
    kras: [
      { name: "Communications Strategy Development", description: "Leads development and implementation of communication strategies aligned with organizational priorities.", rating: "", comment: "" },
      { name: "Marketing Strategy Development", description: "Develops and executes marketing strategies that strengthen brand awareness and engagement.", rating: "", comment: "" },
      { name: "Campaign Planning and Management", description: "Leads planning and execution of communication and marketing campaigns across multiple channels.", rating: "", comment: "" },
      { name: "Strategic Visibility and Positioning", description: "Positions Emerge Livelihoods as a recognized leader and influencer among target audiences.", rating: "", comment: "" },
      { name: "Community Mobilization and Engagement", description: "Supports campaigns that increase participation, engagement and access to organizational services.", rating: "", comment: "" },
    ],
  },
  {
    letter: "B", title: "COMMUNICATIONS, PUBLIC RELATIONS AND MEDIA MANAGEMENT",
    objective: "To strengthen organizational visibility, reputation and stakeholder engagement through effective communication and media relations.",
    kras: [
      { name: "Media Relations Management", description: "Develops and maintains strong relationships with media houses and journalists.", rating: "", comment: "" },
      { name: "Public Relations Management", description: "Plans and implements public relations initiatives that enhance organizational reputation.", rating: "", comment: "" },
      { name: "Press Releases and Storytelling", description: "Produces compelling stories, press releases and communication materials that showcase impact.", rating: "", comment: "" },
      { name: "Stakeholder Communications", description: "Coordinates internal and external communications to ensure consistent messaging.", rating: "", comment: "" },
      { name: "Event and Media Engagement", description: "Coordinates media coverage and stakeholder participation during events and campaigns.", rating: "", comment: "" },
    ],
  },
  {
    letter: "C", title: "MARKETING, DIGITAL MEDIA AND BRAND MANAGEMENT",
    objective: "To strengthen brand visibility, digital engagement and marketing performance across all communication channels.",
    kras: [
      { name: "Brand Management", description: "Ensures consistent application and protection of the Emerge Livelihoods brand identity.", rating: "", comment: "" },
      { name: "Digital Marketing Management", description: "Oversees social media, email marketing, digital advertising and online campaigns.", rating: "", comment: "" },
      { name: "Website Management and Optimization", description: "Ensures websites remain functional, updated, user-friendly and optimized for engagement.", rating: "", comment: "" },
      { name: "Multimedia Content Development", description: "Oversees creation of high-quality multimedia, visual and promotional content.", rating: "", comment: "" },
      { name: "Marketing Analytics and Performance Monitoring", description: "Monitors campaign performance, engagement metrics and return on investment (ROI).", rating: "", comment: "" },
    ],
  },
  {
    letter: "D", title: "PARTNERSHIPS, NETWORKS AND STAKEHOLDER ENGAGEMENT",
    objective: "To build strategic partnerships and networks that enhance organizational visibility, influence and collaboration.",
    kras: [
      { name: "Partnership Development", description: "Builds and maintains productive relationships with partners and stakeholders.", rating: "", comment: "" },
      { name: "Network Representation", description: "Represents the organization in local, national and international forums and events.", rating: "", comment: "" },
      { name: "Media and Storytelling Partnerships", description: "Develops collaborative relationships with media and storytelling partners.", rating: "", comment: "" },
      { name: "Stakeholder Engagement and Communication", description: "Strengthens communication and information-sharing mechanisms with stakeholders.", rating: "", comment: "" },
      { name: "Brand Visibility Reviews", description: "Coordinates assessments and reviews of organizational visibility and outreach efforts.", rating: "", comment: "" },
    ],
  },
  {
    letter: "E", title: "TEAM LEADERSHIP, PERFORMANCE MANAGEMENT AND CAPACITY BUILDING",
    objective: "To develop and lead a high-performing communications and marketing team.",
    kras: [
      { name: "Team Leadership and Supervision", description: "Provides leadership, direction and support to communications and marketing staff.", rating: "", comment: "" },
      { name: "Performance Management", description: "Conducts performance planning, coaching, reviews and feedback processes.", rating: "", comment: "" },
      { name: "Staff Development and Mentorship", description: "Builds staff capacity through coaching, mentoring and professional development opportunities.", rating: "", comment: "" },
      { name: "Resource and Workload Management", description: "Ensures effective allocation of tasks, resources and responsibilities.", rating: "", comment: "" },
      { name: "Team Collaboration and Culture", description: "Promotes teamwork, innovation, accountability and positive working relationships.", rating: "", comment: "" },
    ],
  },
  {
    letter: "F", title: "MONITORING, EVALUATION, LEARNING AND REPORTING",
    objective: "To ensure communication and marketing initiatives are evidence-based, measurable and continuously improved.",
    kras: [
      { name: "KPI Monitoring and Performance Tracking", description: "Monitors achievement of communication and marketing targets and objectives.", rating: "", comment: "" },
      { name: "Marketing Analytics and Insights", description: "Produces reports on engagement, reach, conversions and campaign effectiveness.", rating: "", comment: "" },
      { name: "Learning and Adaptation", description: "Utilizes performance findings to improve future communication and marketing initiatives.", rating: "", comment: "" },
      { name: "Knowledge Management and Documentation", description: "Supports documentation and dissemination of organizational achievements and lessons learned.", rating: "", comment: "" },
      { name: "Budget Monitoring and Reporting", description: "Monitors communication and marketing expenditure against approved budgets.", rating: "", comment: "" },
    ],
  },
  {
    letter: "G", title: "POLICY MANAGEMENT, SAFEGUARDING AND COMPLIANCE",
    objective: "To ensure compliance with organizational policies, safeguarding standards, communication ethics and regulatory requirements.",
    kras: [
      { name: "Policy Development and Implementation", description: "Supports development and implementation of communication and marketing policies and procedures.", rating: "", comment: "" },
      { name: "Data Protection and Information Management", description: "Ensures compliance with data protection regulations and responsible information management.", rating: "", comment: "" },
      { name: "Safeguarding and Inclusion", description: "Promotes safeguarding, gender equality, social inclusion and ethical communication practices.", rating: "", comment: "" },
      { name: "Governance and Compliance", description: "Ensures communication activities comply with organizational and donor requirements.", rating: "", comment: "" },
      { name: "Ethics and Professional Conduct", description: "Upholds integrity, transparency, accountability and organizational values.", rating: "", comment: "" },
    ],
  },
];
...
// ─── Main Form ────────────────────────────────────────────────────────────────
export default function TLCMTeamLeaderCommunicationsMarketingForm() {
  const [employeeId, setEmployeeId] = useState("");
  const [employeeName, setEmployeeName] = useState("");
  const [position, setPosition] = useState("Team Leader - Communications and Marketing");
  ...
  const { clearDraft } = useFormDraft("tlcm-team-leader-communications-marketing", {
  ...
  function resetForm() {
    setEmployeeId(""); setEmployeeName(""); setPosition("Team Leader - Communications and Marketing"); setReviewPeriod(""); setAppraisalDate(""); setReviewers("");
    ...
    <div style={{ fontFamily: "Verdana, Geneva, sans-serif", color: "#222", background: "#f0f4f5", padding: "40px 24px 60px", minHeight: "100vh" }}>
      ...
      <div ref={formTopRef} className="af" style={{ maxWidth: 1050, margin: "0 auto", background: "#fff", border: "2px solid #4C808A", borderRadius: 8, padding: "40px 36px 48px", lineHeight: 1.45 }}>
        ...
        <div className="mh">
          ...
          <p className="subtitle">Team Leader - Communications and Marketing</p>
        </div>
        ...
        <p className="ov">This 360-degree performance appraisal evaluates the Team Leader – Communications and Marketing (TL-CM) across seven core dimensions derived from the role's responsibilities. The appraisal places strong emphasis on Communications Strategy, Marketing and Brand Management, Media and Public Relations, Partnerships and Networking, Team Leadership and Organizational Visibility, recognizing the critical role the position plays in strengthening Emerge Livelihoods' brand, stakeholder engagement, resource mobilization efforts, digital presence and public influence in support of the Strategic Plan 2024–2029.</p>
